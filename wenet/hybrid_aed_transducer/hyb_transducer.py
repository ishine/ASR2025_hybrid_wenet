...
class HybTransducer(ASRModel):
    ...
    def forward(
        ...
        # compute_loss
        loss_rnnt, loss_att, acc_att = self._compute_rnnt_loss(encoder_out,
                                       encoder_out_lens,
                                       encoder_mask,
                                       text,
                                       text_lengths,
        ...
        #     loss_att, acc_att = self._calc_hybrid_att_loss(encoder_out, encoder_mask,
        #                                             text, text_lengths)
        # else:
        #     acc_att = None
    ...
    def _cal_transducer_score(
        ...
        ######################
        ##revised by wenjieRen 2025.1.3
        ##revised for hybrid AED+Transducer model
        ######################
        ...
        predictor_out = decoder_out   #predictor_out is decoder_out   
        # 1. Forward predictor
    ...
    def _compute_rnnt_loss(self,
        ...
        r_ys_pad = reverse_pad_list(text, text_lengths, float(self.ignore_id))
        ...
        return loss, loss_att, acc_att

    def _calc_hybrid_att_loss(
        self,
        encoder_out: torch.Tensor,
        encoder_mask: torch.Tensor,
        ys_pad: torch.Tensor,
