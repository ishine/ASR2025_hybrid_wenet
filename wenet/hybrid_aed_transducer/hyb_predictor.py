...
class HybPredictorBase(torch.nn.Module):
...
class HybRNNPredictor(HybPredictorBase):
...
class HybEmbeddingPredictor(HybPredictorBase):
    """Embedding predictor
...
class HybConvPredictor(HybPredictorBase):
